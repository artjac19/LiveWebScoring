...
Public Class GetLeaderboardSP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim sArrSpecs = LiveWebScoreBoard.ModDataAccess.GetTournamentSpecs(sSanctionID)
            ...
            ElseIf sLoadAllDivisions = "1" Then
                ...
                Dim slalomDivs = LiveWebScoreBoard.ModDataAccess3.LoadDvData(sSanctionID, "S")
                Dim trickDivs = LiveWebScoreBoard.ModDataAccess3.LoadDvData(sSanctionID, "T")
                Dim jumpDivs = LiveWebScoreBoard.ModDataAccess3.LoadDvData(sSanctionID, "J")
            ...
            ElseIf sGetRecentScores = "1" Then
                ...
                Dim recentScores = LiveWebScoreBoard.ModDataAccess3.GetRecentScores(sSanctionID, 20, hoursBack)
                Dim serializer As New JavaScriptSerializer()
                jsonResponse = serializer.Serialize(New With {
                    .success = True,
    ...
    Private Function BuildDivisionInfoJson(sSanctionID As String, sEventCodePkd As String) As String
        Dim info = New With {
            .success = True,
            .availableDivisions = LiveWebScoreBoard.ModDataAccess3.LoadDvData(sSanctionID, sEventCodePkd)
        }
    ...
    Private Function BuildLeaderboardJson(sSanctionID As String, sYrPkd As String, sTournName As String, sEventCodePkd As String, sDivisionCodePkd As String, sRndsPkd As String, sSlalomRounds As Int16, sTrickRounds As Int16, sJumpRounds As Int16, sUseNops As Int16, sUseTeams As Int16, sFormatCode As String, sDisplayMetric As Int16) As String
        ...
        Select Case sEventCodePkd
            Case "S"
                sPlcmntFormat = LiveWebScoreBoard.ModDataAccessPro.GetPlcmtFormat(sSanctionID, "Slalom")
                ...
                If UCase(sPlcmntFormat) = "ROUND" Then
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.LeaderBoardROUND(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    End If
                Else
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    End If
                End If
            Case "T"
                sPlcmntFormat = LiveWebScoreBoard.ModDataAccessPro.GetPlcmtFormat(sSanctionID, "Trick")
                ' Use LeaderBoardROUND only if placement format is ROUND (match TLeaderBoardSP logic exactly)
                If UCase(sPlcmntFormat) = "ROUND" Then
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.LeaderBoardROUND(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    End If
                Else
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.LeaderBoardBestRndLeftSP(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    End If
                End If
            Case "J"
                sPlcmntFormat = LiveWebScoreBoard.ModDataAccessPro.GetPlcmtFormat(sSanctionID, "Jump")
                ' Use LeaderBoardROUND only if placement format is ROUND (match TLeaderBoardSP logic exactly)
                If UCase(sPlcmntFormat) = "ROUND" Then
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.LeaderBoardROUND(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
                    End If
                Else
                    If isCollegiate Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccessTeams.LeaderBoardBestRndLeft(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), CShort(CInt(sUseNops)), CShort(CInt(sUseTeams)), sFormatCode, sDisplayMetric)
    ...
    Private Function BuildRunningOrderJson(sSanctionID As String, sYrPkd As String, sTournName As String, sEventCodePkd As String, sDivisionCodePkd As String, sRndsPkd As String, sSlalomRounds As Int16, sTrickRounds As Int16, sJumpRounds As Int16, sUseNops As Int16, sUseTeams As Int16, sFormatCode As String, sDisplayMetric As Int16) As String
        ...
        sRunOrdCountArray = LiveWebScoreBoard.ModDataAccess3.GetRunOrdercount(sSanctionID, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds))
        ...
        Else
            ...
            Select Case sEventCodePkd
                Case "S"
                    If sMultiS = "1" Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.ScoresXMultiRunOrdHoriz(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.ScoresXRunOrdHoriz(sSanctionID, sYrPkd, sTournName, "S", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                    End If
                Case "T"
                    If sMultiT = "1" Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.ScoresXMultiRunOrdHoriz(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                    Else
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.ScoresXRunOrdHoriz(sSanctionID, sYrPkd, sTournName, "T", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                    End If
                Case "J"
                    If sMultiJ = "1" Then
                        sHtmlContent = LiveWebScoreBoard.ModDataAccess3.ScoresXMultiRunOrdHoriz(sSanctionID, sYrPkd, sTournName, "J", sDivisionCodePkd, sRndsPkd, CStr(sSlalomRounds), CStr(sTrickRounds), CStr(sJumpRounds), sUseNops, sUseTeams, sFormatCode, sDisplayMetric)
                    Else
    ...
    Private Function GetOnWaterData(sSanctionID As String, sSlalomRounds As Int16, sTrickRounds As Int16, sJumpRounds As Int16) As Object
        ...
        If sSlalomRounds > 0 Then
            sOWSlalom = LiveWebScoreBoard.ModDataAccess3.LoadOnWaterSlalom(sSanctionID)
            If Left(sOWSlalom, 2) = "No" Then sOWSlalom = ""
        End If

        If sTrickRounds > 0 Then
            sOWTrick = LiveWebScoreBoard.ModDataAccess3.LoadOnWaterTrick(sSanctionID)
            If Left(sOWTrick, 2) = "No" Then sOWTrick = ""
        End If

        If sJumpRounds > 0 Then
            sOWJump = LiveWebScoreBoard.ModDataAccess3.LoadOnWaterJump(sSanctionID)
